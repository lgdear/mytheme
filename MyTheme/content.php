<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		<h1 class="entry-title"><a href="<?php the_permalink(); ?>
		    " title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'MyTheme' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark">
		    <?php the_title(); ?></a>
        </h1>
	...
	<?php if ( is_search() || is_tag() || is_category() || is_archive()) :  ?>
	...
	<footer class="entry-meta">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<span class="cat-links">
				<?php printf( __( 'Posted in %1$s', 'MyTheme' ), $categories_list ); ?>
			</span>
			...
			<span class="tags-links">
				<?php printf( __( 'Tagged %1$s', 'MyTheme' ), $tags_list ); ?>
			</span>
		...
		<?php edit_post_link( __( 'Edit', 'MyTheme' ), '<span class="sep"> | </span><span class="edit-link">', '</span>' ); ?>
	</footer> <!-- .entry-meta -->
